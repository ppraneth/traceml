...
import traceml.utils.patches.forward_auto_timer_patch as fwd_patch
import traceml.utils.patches.h2d_auto_timer_patch as h2d_patch
import traceml.utils.timing as timing_module
from traceml.utils.patches.h2d_auto_timer_patch import (
    _H2D_TLS,
    _ORIG_TENSOR_TO,
    _is_cuda_target,
    _traceml_tensor_to,
...
from traceml.wrappers import wrap_h2d
...
def _reload_initialization():
    import traceml.initialization as m

    return importlib.reload(m)


def _reload_h2d_patch():
    import traceml.utils.patches.h2d_auto_timer_patch as m
...
class TestH2DAutoTimerPatch:
    ...
    def test_patched_to_skips_timing_when_disabled(self):
        ...
        with patch(
            "traceml.utils.patches.h2d_auto_timer_patch.timed_region",
